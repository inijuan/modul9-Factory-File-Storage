...
<div class="container">
    <div class="row justify-content-center">
        <div style="margin-top:130px;" class="col-md-5">
            <div class="card">
                <i style="color:blue; margin-left:250px; font-size:50px;" class="bi-hexagon-fill me-6"></i>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\juand\OneDrive - ypt.or.id\SEMESTER 4\PEMPROGRAMAN FRAMEWORK\latihan_modul8-auth-master\resources\views/auth/login.blade.php ENDPATH**/ ?>